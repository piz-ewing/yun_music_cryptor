...
{
    auto enc_text = music::MusicDecrypt().aes_encrypt("{\"ids\":\"[28949499]\",\"level\":\"standard\",\"encodeType\":\"aac\",\"csrf_token\":\"\"}");
    ...
    BOOST_TEST(music::MusicDecrypt().aes_encrypt(enc_text, "GR1dIlooUjX3zmY1") ==
...
BOOST_AUTO_TEST_CASE(TestCase_4_rsa_encrypt)
{
    ...
    BOOST_TEST(music::MusicDecrypt().rsa_encrypt("GR1dIlooUjX3zmY1") ==
...
BOOST_AUTO_TEST_CASE(TestCase_4_paket_body)
{
    ...
    BOOST_TEST(music::MusicDecrypt().paket_body("28949499", "GR1dIlooUjX3zmY1") == 
