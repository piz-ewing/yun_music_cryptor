...
BOOST_AUTO_TEST_CASE(TestCase_4_aes_encrypt)
{
    ...
    enc_text = music::MusicDecrypt().aes_encrypt(enc_text, "GR1dIlooUjX3zmY1");
    BOOST_TEST(enc_text ==
...
BOOST_AUTO_TEST_CASE(TestCase_4_rsa_encrypt)
{
    ...
    auto enc_text = music::MusicDecrypt().rsa_encrypt("GR1dIlooUjX3zmY1");
    BOOST_TEST(enc_text ==
...
BOOST_AUTO_TEST_CASE(TestCase_4_paket_body)
{
    ...
    auto pkg = music::MusicDecrypt().paket_body("28949499", "GR1dIlooUjX3zmY1");
    BOOST_TEST(pkg ==
